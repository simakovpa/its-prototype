export const objects = [{ id: 'obj-ps-severnaya', name: 'ПС Северная 110/10 кВ', type: 'ПС' }]
...
export const tmcs = [
  { id: 'tmc-t1', tmId: 'tm-t1', kind: 'equipment', tmcType: 'transformer', nomenclatureId: 'nom-tdtn-40000-110', serialNumber: '2003-1187', commissioningDate: '2003-06-15', name: 'Трансформатор Т-1' },
  { id: 'tmc-t1-bushing', tmId: 'tm-t1', kind: 'equipment', tmcType: 'bushing', nomenclatureId: 'nom-vvbo-110', serialNumber: 'B-2015-04', commissioningDate: '2015-09-01', name: 'Ввод ВВБО-110 (Т-1)' },
  { id: 'tmc-t2', tmId: 'tm-t2', kind: 'equipment', tmcType: 'transformer', nomenclatureId: 'nom-tdtn-63000-110', serialNumber: '2019-0231', commissioningDate: '2019-04-10', name: 'Трансформатор Т-2' },
  { id: 'tmc-t2-bushing', tmId: 'tm-t2', kind: 'equipment', tmcType: 'bushing', nomenclatureId: 'nom-vvbo-110', serialNumber: 'B-2019-11', commissioningDate: '2019-04-10', name: 'Ввод ВВБО-110 (Т-2)' },
]

export const defects = [
  { id: 'defect-1', targetKind: 'tmc', targetId: 'tmc-t1', typeId: 'def-bak-crack', status: 'open', openedDate: '2025-11-02' },
  { id: 'defect-2', targetKind: 'tmc', targetId: 'tmc-t1', typeId: 'def-winding-geometry', status: 'open', openedDate: '2026-02-18' },
  { id: 'defect-3', targetKind: 'tmc', targetId: 'tmc-t1', typeId: 'def-contact-overheat', status: 'closed', openedDate: '2024-05-01' },
]
